...
public class DateUtils {
    ...
    public static long str2long(String time, String format) {
        long re_time = 0;
        try {
            re_time = new SimpleDateFormat(format).parse(time).getTime();
    ...
    public static String int2Str(int time) {
        return int2Str(time, DEFAULT_FORMAT);
    }
     ...
     * @return 相差秒数
     */
    public static int compareTimeUseDefaultFormat(String time1, String time2) {
        int i = 0;
        try {
            i = compareTime(time1, time2, DEFAULT_FORMAT);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return i;
    ...
    public static Date convert2DateTime(String datetimeStr) {
        return convert2DateTime(datetimeStr, DEFAULT_FORMAT);
    }
