...
public class PagerTab extends ViewGroup {
    ...
    private int mIndicatorColor = 0xFFFF7624;//指示器颜色
  ...
  //  private int mTabBackgroundResId = R.drawable.selector_parking_coupon_tab_bg;// tab背景资源
    private int mTabTextColorResId = R.color.selector_parking_coupon_tvcolor; //tab文字颜色
...
//        tab.setBackgroundDrawable(UIUtils.getDrawableLeft(mTabBackgroundResId));
