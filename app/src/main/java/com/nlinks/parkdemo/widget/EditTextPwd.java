 ...
 * 带删除功能的EditText
 */
public class EditTextPwd extends EditText implements View.OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
...
//        init();
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.ic_pwd_eye_off);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mClearDrawable != null && event.getAction() == MotionEvent.ACTION_UP) {
            ...
            // && (x < (getWidth() - getPaddingRight() + 10));//右侧距离
            ...
            if (isInnerWidth) {
                if (isCipherText) {
                    mClearDrawable = getResources().getDrawable(R.mipmap.ic_pwd_eye_on);
