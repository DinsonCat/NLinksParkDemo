package com.nlinks.parkdemo.widget.mzbanner;
...
import com.nlinks.parkdemo.widget.mzbanner.transformer.CustomTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    public void start() {
        ...
        if (mIsCanLoop && mAdapter.mDatas.size() > 1) {
            mIsAutoPlay = true;
    ...
    public void setPages(List<T> datas, MZHolderCreator mzHolderCreator) {
        if (datas == null || mzHolderCreator == null) {
            mAdapter = new MZPagerAdapter(datas, mzHolderCreator, false);
            return;
        }
        mDatas = datas;
