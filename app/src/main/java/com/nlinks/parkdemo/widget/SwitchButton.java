...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            ...
            margin = ta.getDimension(R.styleable.SwitchButton_ThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButton_ThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButton_ThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButton_ThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButton_ThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButton_ThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButton_ThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButton_ThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.SwitchButton_BackRadius, thumbRadius + density * 2f);
            ...
            backMeasureRatio = ta.getFloat(R.styleable.SwitchButton_BackMeasureRatio, backMeasureRatio);
            ...
            textMarginH = ta.getDimension(R.styleable.SwitchButton_TextMarginH, textMarginH);
            autoAdjustTextPosition = ta.getBoolean(R.styleable.SwitchButton_AutoAdjustTextPosition, autoAdjustTextPosition);
            ta.recycle();
        }
